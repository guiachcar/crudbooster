    ...
    public function postExportData()
    {
        ...
        switch ($filetype) {
            case "pdf":
                ...
                break;
            case 'xls':
                return Excel::store($filename . ".xls");
                break;
            case 'csv':

                return Excel::store($filename . ".csv");
                break;
        }
    }
            ...
            foreach ($select_column as $sk => $s) {
                ...
                if (CRUDBooster::isForeignKey($colname)) {
                    ...
                    if (intval($value[$sk])) {
                        ...
                        $relation_insert_data[$title_field] = $value[$sk];
                        ...
                        try {
                            $relation_exists = DB::table($relation_table)->where($title_field, $value[$sk])->first();
                            if ($relation_exists) {
